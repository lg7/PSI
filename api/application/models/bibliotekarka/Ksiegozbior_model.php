...
class Ksiegozbior_model extends CI_Model
{
	...
	{
		$this->db->select('kopie_ksiazek.nr_inwentarza, katalog_systematyczny.znak_miejsca, ksiazki.tytul, autor_ksiazki.nazwa_autora, ksiazki.rok_wydawca, ksiazki.cena, ksiazki.data_wpisu, kopie_ksiazek.uwagi, pochodzenie_ksiazki.nazwa_podzodzenia');
